...
- frontend API-client failures should include the endpoint name plus the concrete HTTP method and request URL in both network-failure and non-OK HTTP error messages so local-runtime debugging can distinguish proxy, port, and path mistakes quickly
